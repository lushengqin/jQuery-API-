...
console.log('你好 我是jQuery'); // window.jQuery = function(selector){
  ...
  return {
    ...
    find: function find(selector) {
      ...
      for (var i = 0; i < elements.length; i++) {
        ...
        console.log(array[i]); // array = array.concat(Array.from(elements[i].querySelectorAll(selector)))
        // console.log(array[i])
    ...
    children: function children() {
      ...
      this.each(function (node) {
        if (array.indexOf(node.parentNode) === -1) {
          array.push.apply(array, _toConsumableArray(node.children)); //... 等价于 node.children[0],node.children[1],node.children[2]
        }
      });
      return jQuery(array);
    }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1223" + '/');
...
},{}]},{},["C:/Users/pc/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js","jQuery.js"], null)
